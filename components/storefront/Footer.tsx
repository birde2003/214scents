      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1">
            <h3 className="font-serif text-2xl font-bold mb-4 bg-gradient-to-r from-primary to-primary-300 bg-clip-text text-transparent">
              214 Scents
            </h3>
          ...
          <div>
            ...
            <form className="space-y-2">
              <input
                ...
                className="w-full px-4 py-2 bg-background border border-primary/30 rounded-lg focus:outline-none focus:border-primary transition-colors"
              />
              <button
                type="submit"
                className="w-full bg-primary hover:bg-primary-600 text-background px-4 py-2 rounded-lg font-semibold transition-all transform hover:scale-105"
              >
                {t('subscribe')}
              </button>
            </form>
        ...
        <div className="mt-8 pt-8 border-t border-primary/20 text-center text-gray-400 text-sm">
          <p>© {currentYear} 214 Scents. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
